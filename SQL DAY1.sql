...
FROM Production.Product
Where (Name like 'Seat%' OR (Name like 'Short-Sleeve%' AND (Name like '%L' or name like '%M') AND name not like '%XL'))
ORDER BY Name 
...
SELECT Name,ListPrice
FROM Production.Product
WHERE Name like 'A%' OR NAME LIKE 'SEAT%' AND (NAME NOT LIKE '%Stays' and name not like'%tube')
ORDER BY Name 
